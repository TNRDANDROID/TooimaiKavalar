...
import com.nic.thooimaikaavalar.databinding.CameraScreenBinding;
import com.nic.thooimaikaavalar.model.RealTimeMonitoringSystem;
import com.nic.thooimaikaavalar.session.PrefManager;
import com.nic.thooimaikaavalar.support.MyEditTextView;
...
public class CameraScreen extends AppCompatActivity implements View.OnClickListener, Api.ServerResponseListener {
    ...
    private com.nic.thooimaikaavalar.dataBase.dbData dbData = new dbData(this);
