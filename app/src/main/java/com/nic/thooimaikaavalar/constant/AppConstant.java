package com.nic.thooimaikaavalar.constant;
...
public class AppConstant {
    ...
    public static String KEY_ADDITIONAL_DETAILS = "additional_details";
    ...
    public static String KEY_ADDITIONAL_DATA_STATUS = "additional_data_status";
    public static String KEY_LENGTH_WATER_STORAGE = "length_water_storage";
    public static String KEY_OBSERVATION = "observation";
    public static String KEY_OBSERVATION_SERVICE = "observation_premonsoon_gw_depth_in_m";
    public static String KEY_NO_TRENCHES_PER_WORKSITE = "no_trenches_per_worksite";
    public static String KEY_NO_UNITS = "no_units";
    public static String KEY_DEPTH = "depth";
    public static String KEY_NO_UNITS_PER_WATERBODY = "no_units_per_waterbody";
    public static String KEY_AREA_COVERED = "area_covered";
    public static String KEY_NO_PLANTATION_PER_SITE = "no_plantation_per_site";
    public static String KEY_STRUCTURE_SUMP_AVAILABLE_STATUS = "structure_sump_available_status";
    public static String KEY_INDIVIDUAL_COMMUNITY = "individual_community";
    public static String KEY_LENGTH_CHANNEL = "length_channel";





        public static String KEY_CHECK_DAM_LOCAL = "108";
        public static String KEY_TRENCH_CUTTING_IN_BARREN_FALLOW_LANDS_LOCAL = "478";
        public static String KEY_Injection_well_recharge_shaft_in_water_bodies_LOCAL = "479";
        public static String KEY_Recharge_wells_in_Rivers_Streams_LOCAL = "480";
        public static String KEY_AFFORESTATION_LOCAL = "481";
        public static String KEY_Farm_ponds_LOCAL = "482";
        public static String KEY_Rooftop_RWHS_LOCAL = "486";
        public static String KEY_Recharge_shaft_LOCAL = "483";
        public static String KEY_Soakpit_LOCAL = "484";
        public static String KEY_Sunken_pond_and_desilting_of_channel_LOCAL = "485";





    public static String KEY_CHECK_DAM_PRODUCTION = "108";
    public static String KEY_TRENCH_CUTTING_IN_BARREN_FALLOW_LANDS_PRODUCTION = "612";
    public static String KEY_Injection_well_recharge_shaft_in_water_bodies_PRODUCTION = "613";
    public static String KEY_Recharge_wells_in_Rivers_Streams_PRODUCTION = "614";
    public static String KEY_AFFORESTATION_PRODUCTION = "615";
    public static String KEY_Farm_ponds_PRODUCTION = "184";
    public static String KEY_Rooftop_RWHS_PRODUCTION = "616";
    public static String KEY_Recharge_shaft_PRODUCTION = "472";
    public static String KEY_Soakpit_PRODUCTION = "382";
    public static String KEY_Sunken_pond_and_desilting_of_channel_PRODUCTION = "617";
    public static String KEY_Recharge_Pit_PRODUCTION = "427";
    public static String KEY_PERCOLATION_POND = "618";


    ///  ************* New Service IDs ///////////

    public static String KEY_swm_capacity_of_mcc_in_tones = "swm_capacity_of_mcc_in_tones";
