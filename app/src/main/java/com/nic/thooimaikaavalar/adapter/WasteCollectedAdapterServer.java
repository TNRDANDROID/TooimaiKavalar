...
import com.nic.thooimaikaavalar.databinding.WasteCollectedAdapterItemBinding;
import com.nic.thooimaikaavalar.databinding.WasteCollectedRecyclerItemServerBinding;
...
public class WasteCollectedAdapterServer extends  RecyclerView.Adapter<WasteCollectedAdapterServer.MyViewHolder>{
    ...
    public WasteCollectedAdapterServer(List<RealTimeMonitoringSystem> capacityList, Context context, com.nic.thooimaikaavalar.dataBase.dbData dbData){
